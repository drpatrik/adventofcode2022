...
void day_two() {
  auto strategies = read_strategy_file_part1("input_day2.txt");
  std::cout << "Day1 - Part 1: " << calculate_total_score(strategies) << std::endl;

  strategies = read_strategy_file_part2("input_day2.txt");
